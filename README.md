...
`pnpm verify` is the whole gate: 25 steps across 19 repository guards, linting,
...
tests/guards/      19 executable repository guards (run by pnpm verify)
...
| Guard meta-tests | 68 | `pnpm guard:meta` |
