...
`pnpm verify` is the whole gate: 26 steps across 20 repository guards, linting,
...
tests/guards/      20 executable repository guards (run by pnpm verify)
