...
| [STEP-007](../08-steps/STEP-007-discovery-landing-and-destination-coverage.md) | Discovery landing & coverage | 1 | Expectations set before signup | 003, 006 | **`IN_PROGRESS`** 2/5 | Deepesh Kumar Gupta | NS | ✅ .01–.02 — **the first product route and the first product page** | ✅ `API-017` implemented as declared, no contract change | ✅ migrations 016, 017 — | NS | `BLOCKED` | N/A | NS | NS | ✅ | — | User knows what is supported and what JourneyLab will not do pre-signin | BLK-001 | 2026-08-05 |
