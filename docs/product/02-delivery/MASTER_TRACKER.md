...
| [STEP-002](../08-steps/STEP-002-identity-tenancy-and-authorization.md) | Identity, tenancy & authorization | 1 | Isolation and permission primitives | 001 | **`IN_PROGRESS`** 2/7 | Deepesh Kumar Gupta | NS | ✅ .01–.02 | NS | ✅ .01 | — | ✅ R7 12/12 | `BLOCKED` (static fallback) | ✅ BR-008, BR-010, BR-011 | ✅ 2/7 | ✅ 29 api + 12 R7 | ✅ | — | Cross-tenant ops fail deterministically and are audited | `DEC-004` (binds at .04) | 2026-08-06 |
