...
| [STEP-007](../08-steps/STEP-007-discovery-landing-and-destination-coverage.md) | Discovery landing & coverage | 1 | Expectations set before signup | 003, 006 | **`IN_PROGRESS`** 3/5 | Deepesh Kumar Gupta | NS | ✅ .01–.03 — **the first product route, the first product page, and the first refusal a traveller meets** | ✅ `API-017` as declared; **`API-019` added** (additive, gate-classified) | ✅ migrations 016, 017, 018 | ✅ .03 announces refusals assertively; 58 browser | ✅ **NOT BLOCKED** at .03 — and `RISK-016` #13 found the API application invisible to the graph (BR-061 §2) | ✅ .03 — 20 mutants, 20 killed | ✅ BR-059, BR-060, BR-061 | ✅ 3/5 | ✅ 1378 py + 71 web + 307 ui + 58 browser + 18 R7 | ✅ | — | User knows what is supported and what JourneyLab will not do pre-signin | ~~BLK-001~~; **`DEC-011` open** (3-day lower bound shipped as declared, recommended against) | 2026-09-05 |
