...
| [STEP-002](../08-steps/STEP-002-identity-tenancy-and-authorization.md) | Identity, tenancy & authorization | 1 | Isolation and permission primitives | 001 | **`IN_PROGRESS`** 3/7 | Deepesh Kumar Gupta | NS | ✅ .01–.03 | NS | ✅ .01 | — | ✅ R7 12/12 | ✅ **RUNNABLE** (BR-012) | ✅ BR-008, BR-010, BR-011, BR-012 | ✅ 3/7 | ✅ 276 py + 12 R7 | ✅ | — | Cross-tenant ops fail deterministically and are audited | `DEC-004` (.04), `DEC-010` (fails closed) | 2026-08-06 |
