...
| [STEP-005](../08-steps/STEP-005-source-integrations-and-ingestion.md) | Source integrations & ingestion | 1 | Inputs with consent, provenance, replay | 004 | **`IN_PROGRESS`** 3/7 | — | — | NS | NS | NS | — | NS | — | N/A | NS | NS | ✅ | — | Every source has credentials, limits, checkpoints, reconciliation, deletion | ~~DEC-002~~ **closed 2026-08-13 — Switzerland (`ADR-016`)**. DEC-008, EV-GAP-002 open. **`RISK-001` narrowed, not closed**: OSM is ODbL and the evidence pack is a derivative database — a posture is owed before STEP-010 | 2026-08-13 |
