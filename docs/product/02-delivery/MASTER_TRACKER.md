...
| [STEP-002](../08-steps/STEP-002-identity-tenancy-and-authorization.md) | Identity, tenancy & authorization | 1 | Isolation and permission primitives | 001 | **`IN_PROGRESS`** 3/7 + .04 partial | Deepesh Kumar Gupta | NS | ✅ .01–.04 | NS | ✅ .01, .04 | — | ✅ R7 12/12 | ✅ **RUNNABLE** (BR-012, BR-013) | ✅ BR-008, BR-010…013 | ✅ 3/7 + .04 partial | ✅ 292 py + 12 R7 | ✅ | — | Cross-tenant ops fail deterministically and are audited | `DEC-004` **still open** (not bound by .04); `DEC-010` (fails closed); **REQ-TRIP-005 open** (no trips until STEP-007) | 2026-08-06 |
