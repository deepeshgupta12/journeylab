...
| [STEP-005](../08-steps/STEP-005-source-integrations-and-ingestion.md) | Source integrations & ingestion | 1 | Inputs with consent, provenance, replay | 004 | **`IN_PROGRESS`** 5/10 | — | — | NS | NS | NS | — | NS | — | N/A | NS | NS | ✅ | — | Every source has credentials, limits, checkpoints, reconciliation, deletion | ~~DEC-002~~ **closed 2026-08-13 — Switzerland (`ADR-016`)**. **DEC-008 — recommendation on the table: OpenTripPlanner 2 self-hosted (STEP-005.05 §13), awaiting owner confirmation**, EV-GAP-002 open. **`RISK-001` narrowed, not closed**: OSM is ODbL and the evidence pack is a derivative database — a posture is owed before STEP-010 | 2026-08-13 |
