...
| [STEP-005](../08-steps/STEP-005-source-integrations-and-ingestion.md) | Source integrations & ingestion | 1 | Inputs with consent, provenance, replay | 004 | **`IN_PROGRESS`** 9/10 | — | — | NS | NS | NS | — | NS | — | N/A | NS | NS | ✅ | — | Every source has credentials, limits, checkpoints, reconciliation, deletion | ~~DEC-002~~ **closed 2026-08-13 — Switzerland (`ADR-016`)**. ~~DEC-008~~ **closed 2026-08-17 — OpenTripPlanner 2 self-hosted (`ADR-018`)**, EV-GAP-002 open. **`RISK-001` narrowed, not closed**: OSM is ODbL and the evidence pack is a derivative database — a posture is owed before STEP-010. **`RISK-016` raised at .07**: the code graph reports 0 dependants for symbols with live call sites, so every blast-radius record cross-checks it against a grep | 2026-08-18 |
