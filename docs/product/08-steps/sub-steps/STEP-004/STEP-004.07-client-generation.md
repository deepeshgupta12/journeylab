...
| Unknown / low-confidence areas | The **magnitude** of the graph exclusion is unmeasured — see BR-034 §4. The exclusion itself is verified; the node count it removes is not |
...
- [x] Generated paths excluded from graph coverage — verified by Cypher; **magnitude unmeasured, BR-034 §4**
