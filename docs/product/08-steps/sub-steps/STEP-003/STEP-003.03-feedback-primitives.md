...
| Blast radius | BR-016 — scored at execution; **confidence capped while the graph is BLOCKED** |
| Approval required? | Per blast-radius score (HIGH/CRITICAL/low-confidence ⇒ owner approval) |

## 5. Implementation plan
- [ ] Dialog with focus trap, restoration and escape handling
- [ ] Notification primitive using an appropriate live-region politeness
- [ ] Skeleton, empty, error, **stale-data** and offline primitives
- [ ] Retry affordance built into the error primitive
- [ ] **Never a bare spinner** — progress primitives carry context and a cancel path
...
- [ ] All nine quality states have a primitive
- [ ] Dialog focus behaviour correct
- [ ] Stale-data primitive communicates staleness at point of use, not only globally
...
| Bugs found | — |
| Notes / surprises | The stale-data primitive is product-critical: REQ-EVID-005 requires staleness at the point of use, which a global banner cannot satisfy. |
