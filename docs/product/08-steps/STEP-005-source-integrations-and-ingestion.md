...
| Sub-step | Outcome |
| --- | --- |
| STEP-005.01 | Connector framework: credentials, egress allowlist, rate limit, timeout, circuit breaker |
...
- [ ] Places deduplicate into canonical entities with a provider identifier graph (`REQ-DATA-004`)
