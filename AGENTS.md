...
This project is indexed by GitNexus as **journeylab** (5708 symbols, 7997 relationships, 54 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
