...
This project is indexed by GitNexus as **journeylab** (3377 symbols, 4638 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
