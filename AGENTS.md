...
This project is indexed by GitNexus as **journeylab** (6236 symbols, 8990 relationships, 60 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
