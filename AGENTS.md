...
This project is indexed by GitNexus as **journeylab** (3402 symbols, 4667 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
