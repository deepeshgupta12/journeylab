...
This project is indexed by GitNexus as **journeylab** (3628 symbols, 5004 relationships, 12 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
