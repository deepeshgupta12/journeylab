...
This project is indexed by GitNexus as **journeylab** (3720 symbols, 5179 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
