...
This project is indexed by GitNexus as **journeylab** (6618 symbols, 9653 relationships, 61 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
