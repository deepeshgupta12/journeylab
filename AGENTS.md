...
This project is indexed by GitNexus as **journeylab** (4927 symbols, 6847 relationships, 47 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
