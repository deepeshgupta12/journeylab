...
This project is indexed by GitNexus as **journeylab** (6235 symbols, 8989 relationships, 60 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
