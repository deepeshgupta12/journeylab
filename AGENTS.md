...
This project is indexed by GitNexus as **journeylab** (3591 symbols, 4965 relationships, 12 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
