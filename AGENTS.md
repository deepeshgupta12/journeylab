...
This project is indexed by GitNexus as **journeylab** (3240 symbols, 4380 relationships, 4 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
