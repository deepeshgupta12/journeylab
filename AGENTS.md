...
This project is indexed by GitNexus as **journeylab** (5549 symbols, 7807 relationships, 53 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
