...
This project is indexed by GitNexus as **journeylab** (5994 symbols, 8570 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
