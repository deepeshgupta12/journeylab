...
This project is indexed by GitNexus as **journeylab** (4704 symbols, 6572 relationships, 42 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
